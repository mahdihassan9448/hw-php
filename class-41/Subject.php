    ...
    */
    ...
    class Teacher{
        ...
        function addTeacher($Data)
        {
            ...
            $Query = "INSERT INTO teacher(name, number, education, subject, address)";
        ...
        function editTeacher($Data, $TeacherId)
        {
            ...
            $Query = "UPDATE teacher SET name = $Name, number = $Number, education = $Education, subject = $Subject, address = $Address WHERE id = $TeacherId";
            $Result = $this->Connection->execute_query($Query);
            return $Result;
        }
