<?php
    ...
    if(isset($_POST['submit'])){
        if($_POST['submit'] == 'Data'){
            ...
            echo $Query = "INSERT INTO teacher(name, number, education, subject, address) VALUES('$name', '$number', '$education', '$subject', '$address')";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="index.php?page=add-teacher" enctype="multipart/form-data" novalidate>
                    <div class="col-12">
