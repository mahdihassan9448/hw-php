    ...
    if(isset($_REQUEST['action'])){
        if($_REQUEST['action'] == 'edit'){
            ...
            if($_REQUEST['action'] == 'update'){
                ...
                $Query = "UPDATE student SET name = '$name', roll = '$roll', number = '$number', subject = '$subject', address = '$address' WHERE id = $id";
                $Result = mysqli_query($Connection, $Query);
                if($Result){
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="index.php?page=edit-std&action=update&id=<?php echo $Data['id']; ?>" enctype="multipart/form-data" novalidate>
